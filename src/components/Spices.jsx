  ...
  return (
    <>
      <main className="flex flex-col bg-[#FFF7ED] ">
        ...
        <div ref={ref} className="flex flex-col justify-center items-center ml-20   md:flex md:flex-row md:justify-between  mt-25 mr-20 mb-25 ">
            <motion.div 
            animate={
                isInView
            ? {
            ...
            className="image w-full md:w-[40%] flex overflow:hidden "
            ><motion.img 
            animate={{
            y:[0,-10,0]
        }}
